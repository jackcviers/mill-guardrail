...
trait Deps {
  ...
  def `upickle-core` = ivy"com.lihaoyi::upickle-core:3.3.1"
  def `upickle-implicits` = ivy"com.lihaoyi::upickle-implicits:3.3.1"
  def mainargs = ivy"com.lihaoyi::mainargs:0.6.3"
  def sourcecode = ivy"com.lihaoyi::sourcecode:0.3.1"
  def upickle = ivy"com.lihaoyi::upickle:3.3.1"
